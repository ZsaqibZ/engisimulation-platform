...
export default function ProjectCard({ project }: { project: { _id: string, title: string, description: string, screenshots: string[], tags: string[], software_type: string } }) {
  ...
  useEffect(() => {
    ...
    const fetchLikeStatus = async () => {
      try {
        const res = await fetch(`/api/likes?project_id=${project._id}&check_user=true`) // Use _id for MongoDB
    ...
    if (project._id) fetchLikeStatus()
